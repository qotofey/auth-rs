...
use crate::transports::web::Server;
...
async fn main() {
    ...
    let argon2_hasher = providers::argon2_hasher::Argon2HasherProvider::new(
        ARGON2_MEMORY_COST,
        ARGON2_TIME_COST,
        ARGON2_PARALLELISM,
    );
    let argon2_verifier = providers::argon2_verifier::Argon2VerifierProvider::new(
        ARGON2_MEMORY_COST,
        ARGON2_TIME_COST,
        ARGON2_PARALLELISM,
    );
    ...
    //     .call("qotofey  ".to_string(), "Qwerty123!".to_string())
    //     .await
    //     .unwrap();
    // let res = container
    //     .refresh_session_command
    //     .call(res.refresh_token)
    //     .await
    //     .unwrap();
    // let res = container
    //     .refresh_session_command
    ...
    //     .call(res.user_id, "Qwerty123!".to_string(), "123123".to_string())
    //     .await
    //     .unwrap();
    // let res = container
    //     .authenticate_user_command
    //     .call("qotofey".to_string(), "123123".to_string())
    //     .await
    //     .unwrap();
    // let res = container
    //     .refresh_session_command
    ...
    // let _ = container
    //     .change_password_command
    //     .call(res.user_id, "123123".to_string(), "Qwerty123!".to_string())
    //     .await
    //     .unwrap();
    // let res = container
    //     .refresh_session_command
    ...
    // let _ = container
    //     .delete_user_command
    //     .call(res.user_id, "123123".to_string())
    //     .await
    //     .unwrap();
    // let _ = container
